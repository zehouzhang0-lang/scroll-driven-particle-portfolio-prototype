...
本仓库当前为 Private。教师需要先接受作者发送的 GitHub 协作者邀请，之后可在仓库页面右上方选择 **Code → Download ZIP** 下载安全归档源码。仓库不含原始 FBX；完整运行前需要按照 [assets/README.md](../assets/README.md) 自行提供有权使用的兼容资产。
